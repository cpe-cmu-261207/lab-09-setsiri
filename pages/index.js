      ...
      <Navbar>
        <div class="d-flex gap-5 justify-content-center mx-4">
          ...
          <div>
            ...
            <p>
              ...
              Excepturi, quasi? Lorem ipsum dolor sit amet <br />
        ...
        <div class="d-flex gap-4 mb-3 mx-3 my-3 justify-content-center">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <p class="card-text">
                I used to go in shirt compitition by grandsport company and i
                aslo have alot of project about art and design because it is by
                hobby.
              </p>
            </div>
          </div>
          <div class="card">
            ...
            <div class="card-body">
              <p class="card-text">
                i had experience about scatch project with my friend in last
                year. It call jumpking game.
              </p>
            </div>
          </div>
        </div>
